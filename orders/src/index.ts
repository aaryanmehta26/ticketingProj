...
const start = async () => {
  ...
  try {
    await natsWrapper.connect(process.env.NATS_CLUSTER_ID, process.env.NATS_CLIENT_ID, process.env.NATS_URL); // connecting to Nats Streaming
    // closing the nats client
